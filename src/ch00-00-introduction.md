...
* 카고 (Cargo) 라는 기본 구성에 포함된 의존성 (dependency) 관리자 및 빌드
  도구를 통하여 러스트 생태계에서 의존성을 고통없이 일관되게 추가하고,
  컴파일하고, 관리할 수 있습니다.
...
개발자들은 이 3가지를 포함한 러스트 생태계의 여러 도구들을 이용하여
...
이 책에는 개념 장와 프로젝트 장의 두 가지 종류가 있습니다. 개념
장에서는 러스트에서의 어떤 개념에 대해 알아봅니다. 프로젝트 장에서는
그간 배운 내용을 적용하여 작은 프로그램을 함께 만들어봅니다. 2장,
...
뒷 내용에서 심화적으로 배울 여러 개념을 추상적으로 다뤄볼 수 있습니다.
...
2장으로 돌아와 배운 내용을 프로젝트에 적용해볼 수도 있지요.
...
10장은 여러가지 타입에 적용될 수 있는 코드를 정의하도록 해주는
...
마지막으로, 부록에는 러스트 관련 유용한 정보를 참고자료
