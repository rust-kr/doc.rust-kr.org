...
유용합니다. 이제 `IpAddrKind` 타입을 인자로 받는 함수를 정의해 봅시다:
...
인자로 받는 함수를 정의하기 힘들 것입니다. 예제 6-2에 정의한 `Message`
...
null을 고안한 Tony Hoare의 "Null 참조: 10억 달러의 실수"에서 다음과 같이
말합니다:
