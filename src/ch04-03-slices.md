...
> 멀티바이트 문자 중간에 생성할 경우 프로그램은 에러가 발생하고 강제 종료됩니다.
> UTF-8 문자를 다루는 방법은 8장 [“Storing UTF-8 Encoded Text with Strings”][strings]<!-- ignore -->
> 절에서 자세히 알아볼 예정입니다.

여태 다룬 내용을 잘 기억해 두고, `first_word` 함수가 슬라이스를 반환하도록 재작성해 보죠.
