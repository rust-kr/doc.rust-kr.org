...
첫 번째 상황은 [“박스로 재귀적 타입 가능하게 하기”](#enabling-recursive-types-with-boxes)<!-- ignore -->절에서
보여주겠습니다.
...
참조하는 데이터는 힙상에서 한곳에 머물게 됩니다. 세 번째 경우는
...
가능합니다. 다른 어떤 소유 값과 마찬가지로, `b`가 `main`의 끝에
...
담을 수 있습니다. 컴파일 타임에 러스트는 어떤 타입이 얼마만큼의 공간을 잡아먹는지
...
이용하여 `List`를 정의했기 때문입니다: 즉 이것은 자신의 또 다른 값을 직접 갖습니다.
...
가장 큰 공간은 varient 중에서 가장 큰 것을 저장하는 데 필요한 공간입니다.
