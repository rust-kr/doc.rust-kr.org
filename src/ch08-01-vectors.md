...
꺾쇠 괄호(<>) 안에 해당 타입을 지정합니다. 예제 8-1에서는 러스트에게
...
예제 8-7은 `for` 루프를 사용하여 `i32`의 벡터 내에 있는 각 요소들에 대한
...
참조자로 반복작업을 할 수도 있습니다. 예제 8-8의 `for` 루프는 각 요소에
`50`을 더할 것입니다:
...
<span class="caption">예제 8-10: 벡터와 요소들이 drop되는 위치를
표시</span>
