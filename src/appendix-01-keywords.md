...
* `as` - 기초 타입 변환하기, 어떤 아이템을 포함하는 특정 트레이트를 구분하기,
...
[부록 E][appendix-e]<!-- ignore -->을 참조하세요.
