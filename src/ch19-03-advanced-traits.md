...
트레잇이 있는 경우, *완전 정규화 문법 (fully qualified syntax)* 을 사용하지 않는 한 러스트는
...
있는 트레잇을 트레잇의 *슈퍼트레잇 (supertrait)* 이라고 합니다.
...
10장 [‘특정 타입에 트레잇 구현하기’][implementing-a-trait-on-a-type]<!-- ignore -->절에서
